...
def fline(p0: List, p1: List, debug: bool = False) -> List:
    """
    Calculating the angle of inclination of a straight line from 2 points
    """
    x1 = float(p0[0])
    y1 = float(p0[1])
...
def linearLineMatrix(p0: List, p1: List, verbode: bool = False) -> np.ndarray:
    """
    Calculation of the coefficients of a matrix describing a line by two points
    """
    x1 = float(p0[0])
    y1 = float(p0[1])
...
def getCvZoneRGB(
        img: np.ndarray, rect: list, gw: float = 0, gh: float = 0, coef: float = 4.6, auto_width_height: bool = True
) -> List:
    """
    TODO: describe function
    """
...
def getCvZonesRGB(
        img: np.ndarray, rects: list, gw: float = 0, gh: float = 0, coef: float = 4.6, auto_width_height: bool = True
) -> List:
    """
    TODO: describe function
    """
