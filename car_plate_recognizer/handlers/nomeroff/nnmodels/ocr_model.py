...
from car_plate_recognizer.handlers.nomeroff.tools.ocr_tools import plot_loss, print_prediction
...
class BlockCNN(nn.Module):
    ...
    def forward(self, batch, use_bn=False, use_relu=False, use_maxpool=False, maxpool_kernelsize=None):
        """
        in:
...
class NPOcrNet(pl.LightningModule):
    def __init__(
        ...
        self.gru2 = BlockRNN(hidden_size, hidden_size, letters_max, bidirectional=bidirectional)
