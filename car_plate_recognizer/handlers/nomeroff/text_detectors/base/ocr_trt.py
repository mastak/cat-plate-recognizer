...
from car_plate_recognizer.handlers.nomeroff.data_modules.data_loaders import normalize
from car_plate_recognizer.handlers.nomeroff.tools.ocr_tools import decode_batch
from .ocr import OCR
